...
impl SearchRouter {
    //pub async fn google(State(state): State<AppState>, body: String) -> axum::response::Response {
    ...
    pub async fn categories(
        ...
        let starts_with = match params.get("startsWith") {
        ...
        let categories = categories_table.find_by_name(format!("{}%", starts_with).as_str(), lang);
